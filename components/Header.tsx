...
export function Header() {
  return <>
    <div className="topbar"><div className="shell topbar-inner"><span><Icon name="shield" size={15}/> AIS-140 GPS Approved for All 38 Districts in Bihar</span><div><a href="mailto:routetechgps@gmail.com"><Icon name="mail" size={15}/> routetechgps@gmail.com</a><a href="tel:+918935989871"><Icon name="phone" size={15}/> +91 89359 89871</a><span>+91 84095 39047</span></div></div></div>
