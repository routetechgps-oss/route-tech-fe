...
export function Footer() {
  return <footer className="footer"><div className="shell footer-grid">
    ...
    <div><h3>Contact</h3><a href="tel:+918935989871"><Icon name="phone" size={17}/> +91 89359 89871</a><a href="mailto:support@routetech.in"><Icon name="mail" size={17}/> support@routetech.in</a><span><Icon name="pin" size={17}/> East Lakshmi Nagar, Ramkrishan Nagar, Patna, Bihar – 800027</span></div>
